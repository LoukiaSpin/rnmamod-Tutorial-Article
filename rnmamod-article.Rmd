...
methodological and reporting scope: \CRANpkg{bnma} [@bnma] 
...
the continuous outcomes [@Mavridis2015] defined as the mean outcome given the 
...
@Turner2015] is more likely to be used with the risk ratio for being also a ratio 
of risks. The informative missingness ratio of means is intuitively related to 
the ratio of means [@Mavridis2015]. Finally, IMOR and IMDoM are more likely to be 
...
relevant methodological literature [@Friedrich2008; @Nikolakopoulou2014; 
@Bakbergenuly2019].
...
approach to synthesise the trials [@Turner2015; @Spineli2019]. 
