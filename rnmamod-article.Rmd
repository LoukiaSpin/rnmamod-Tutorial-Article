...
(purple nodes) for the corresponding model. `Baseline_model()` contains all three 
operationalities, whilst `mcmc_diagnostics()` offers only a set with MCMC diagnostics.
