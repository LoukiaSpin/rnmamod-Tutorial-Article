...
Ever since the introduction of indirect evidence and the early development of the corresponding
methodology [@Higgins1996; @Bucher1997], the NMA framework has undergone substantial conceptual and methodological progress
progress. The fast-pace publications of relevant 
methodological articles and systematic reviews including multiple interventions attest 
to the increasing popularity of NMA within the broad medical and evidence synthesis 
community [@GetRealNMA; @Petropoulou2017]. The availability 
of statistical analysis software has been the driving force behind the advances and 
widespead dissemination and adoption of NMA. A comprehensive review of the NMA methodology and software
[@GetRealNMA] listed several statistical software tools used for promoting NMA, with 
the __R__ software [@R2023] being the most popular, followed by __Stata__ [@Stata] 
and __SAS software__ [@SAS2020]. Over the past decade, there has been a rise in the development of
R packages tailored for NMA, each offering distinct functionalities [@CRANTaskReview].
