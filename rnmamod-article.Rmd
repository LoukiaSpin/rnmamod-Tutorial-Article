...
The present article introduces the R package __rnmamod__ that also performs 
Bayesian hierarchical NMA in JAGS through the R package \CRANpkg{R2jags} [@R2jags],
while modeling missing participants using one-stage pattern-mixture models [@Little1993].
The visualisation toolkit has been developed using the R package \CRANpkg{ggplot2} 
[@ggplot2] to benefit from the flexibility offered in creating and customising 
quality graphs.
