...
In section [5](#X) we illustrate the various functions of the package on example 
datasets from published systematic reviews including NMA. Finally, Section [6](#X) 
