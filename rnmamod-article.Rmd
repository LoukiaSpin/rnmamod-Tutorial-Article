...
__SAS__ software [@SAS2020]. 

In the last decade, there has been a raise in the R packages for NMA with various 
functionalities [@CRANTaskReview]. These packages can be categorised by, among others, 
...
framework based on the graph theory [@Ruecker2012], allows only for a two-approach 
