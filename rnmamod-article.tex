...
(\CRANpkg{nmaplateplot} (Z. Wang et al. 2021)), or an intervention hierarchy approach
...
in NMA. Section \protect\hyperlink{X}{3} exemplifies the several functions of the package using
examples from published systematic reviews with NMA. Finally, Section \protect\hyperlink{X}{4}
