...
(purple nodes) for the corresponding model. \texttt{Baseline\_model()} contains all three
operationalities, whilst \texttt{mcmc\_diagnostics()} offers only a set with MCMC diagnostics.
...
functions alongside \texttt{run\_model()} and several model-related functions. All
