...
outcome data in NMA. Section \protect\hyperlink{X}{3} exemplifies the several functions of the
package using examples from published systematic reviews with NMA. Finally,
Section \protect\hyperlink{X}{4} concludes with a discussion on the limitations and future
